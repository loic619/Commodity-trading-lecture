...
const topic: Topic = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'Volume & Open Interest: Reading the Screen\u2019s Two Counters',
      body: `Next to every futures price the screen shows two numbers that beginners constantly confuse \u2014 and professionals read like a heartbeat.\n\n**Volume** counts every lot that TRADED today. It measures **activity**, and it resets to zero each morning.\n\n**Open interest (OI)** counts every lot still OUTSTANDING \u2014 open promises registered with the clearing house, carried overnight until they are closed, rolled or delivered. It measures **positions**.\n\nThe mechanics fit in two trades \u2014 step through them below:\n\n1. **A buys 1 lot, B sells 1 lot.** One lot traded: volume +1. Both parties now hold an open position against the clearing house: **OI +1**. New risk was CREATED.\n2. **A sells its lot to C.** One more lot traded: volume +1 again. But the promise merely **changed hands** \u2014 A is out, C is the new long, B never moved: **OI unchanged**. No new risk, just a new owner.\n\n(The missing third case: A buys back from B directly \u2014 both sides CLOSE, volume +1, **OI \u22121**. Risk destroyed.)\n\nWhy the pair matters:\n\n- **Volume high, OI rising** \u2014 new money is entering: fresh longs meeting fresh shorts. Conviction behind the move.\n- **Volume high, OI flat** \u2014 positions are churning hands: day-traders passing the same risk around.\n- **Volume high, OI falling** \u2014 holders are LEAVING: longs and shorts closing against each other. A rally on falling OI is shorts covering, not buyers arriving.\n- **OI draining from the nearby contract** \u2014 the roll: holders who want no part of physical delivery migrate to the next month. You will see exactly this on the desk screen later in this module \u2014 a nearby with almost no OI left is a contract whose remaining holders all have a delivery plan (do you?).`,
      visual: 'volume-oi-flow',
    },
    {
      id: 'margin-mechanics',
      title: 'Margin: the Cash Reality of a Hedge',
      body: `"Marked to market daily" is not an abstraction — it is **cash leaving or entering your account every day**. Run the week yourself in the simulator: you are an exporter **short 10 lots of Robusta (100 t), sold at \\$4,500/t** to hedge unsold physical, with **\\$60,000 of initial margin** posted via your clearing member. Each \\$1/t move = \\$100 on the position.\n\nSet each day's settlement on the chart — move the price point, **fix it**, and move to the next day, four times. The **daily variation margin** and the **cumulative cash line** compute as you go.\n\nTwo experiments:\n\n1. **Rally week** — settle the market up day after day (try 4,520 → 4,610 → 4,580 → 4,700): watch \\$20,000 wire out of the account in four days, while the physical coffee that "backs" the hedge sits in the warehouse, unsold and unfinanceable. The hedge is *economically* perfect and *cash-flow* brutal.\n2. **Break week** — settle it down instead: the hedge now *pays you* daily while the stock loses the same on paper. Symmetric — and just as misleading if the cash gets spent.\n3. **Bust the line** — the desk has a **\\$60,000 VM funding line** (the gauge on the right) that funds each losing day's **margin call**. Watch the daily table: every red day shows its call being **funded** and the line draining. Settle the market up hard enough and a call lands that the line cannot fund — it goes **UNMET**, and *that* is the moment your clearing member closes the position for you, at the top. A margin call is never itself a liquidation; the first unfunded one is. Try it once, on purpose.\n\nThis **margin-funding risk** is what broke Ashanti's gold hedges in 1999 and squeezed European utilities in 2022. A hedging program without a liquidity line is a speculation on your own funding.`,
